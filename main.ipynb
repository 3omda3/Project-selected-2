...
rf = Roboflow(api_key="vk8XXAJah3oR5ORLMOGk")
project = rf.workspace("kareem-hosny").project("final-yiao6")
...
test_images = [f for f in os.listdir('Final-1/test') if f.endswith('.jpg')]
import random
img_path = "Final-1/test/" + random.choice(test_images);
